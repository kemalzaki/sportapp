...
<div class="row g-3 mb-3">
  ...
  <div class="col-md-3"><a href="/panduan_adzan.php" class="card text-decoration-none h-100 border-primary"><div class="card-body text-center"><i class="bi bi-megaphone-fill fs-2 text-primary"></i><div class="fw-semibold mt-1">Panduan Adzan</div><div class="small text-muted">Lafadz, terjemah, cara menjawab</div></div></a></div>

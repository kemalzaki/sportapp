  ...
  <div class="col-lg-4">
    <div class="card shadow-sm"><div class="card-body text-center">
      ...
      <div class="mt-2"><span class="pill">Level <?= $level ?></span>
        <span class="pill">🔥 <?= (int)$me['streak_minggu'] ?> minggu</span>
  ...
  <div class="col-lg-8">
    ...
    <div class="card-body">
      <div class="row g-2">
        ...
        <div class="col-6 col-md-3"><div class="card card-stat"><div class="card-body"><div class="stat-label">Streak (mgg)</div><div class="stat-value"><?= (int)$me['streak_minggu'] ?></div></div></div></div>

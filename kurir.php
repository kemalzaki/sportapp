...
if ($_SERVER['REQUEST_METHOD']==='POST') {
    ...
    $id = (int)($_POST['id'] ?? 0);
    if ($a==='take' && $id) {
        // ambil order yang belum ada kurirnya
...
<p class="text-muted small">Sebagai member terdaftar, kamu bisa mengambil order pengantaran jajanan dari masyarakat umum.</p>

...
<div class="card shadow-sm mb-3"><div class="card-body">
  <div class="d-flex justify-content-between align-items-start gap-2 flex-wrap">
    ...
    <div class="d-flex gap-2">
      <a href="<?= htmlspecialchars($maps) ?>" target="_blank" rel="noopener" class="btn btn-success"><i class="bi bi-google"></i> Lihat di Google Maps</a>
  ...
  <div class="row g-3">
    <div class="col-md-6">
      <table class="table table-sm mb-0">
        ...
        <?php if($r['kontak_wa']): ?><tr><th>Kontak</th><td><?= htmlspecialchars($r['kontak_wa']) ?></td></tr><?php endif; ?>
    ...
    <div class="col-md-6">
      <?php if($r['lat'] && $r['lng']): ?>
        <iframe width="100%" height="320" style="border:0;border-radius:8px" loading="lazy" src="https://maps.google.com/maps?q=<?= $r['lat'] ?>,<?= $r['lng'] ?>&z=15&output=embed"></iframe>
      <?php else: ?>

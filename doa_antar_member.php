...
<div class="card mb-2"><div class="card-body">
 <div class="d-flex justify-content-between"><div class="d-flex align-items-center gap-2"><?= user_avatar($r['foto_url']??null,$r['nama'],28) ?> <strong><?= htmlspecialchars($r['nama']) ?></strong> <span class="small text-muted">· <?= htmlspecialchars($r['created_at']) ?></span></div>

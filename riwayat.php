...
<?php /* ================= Revisi Juli 2026 R3 =================
   - Pindahkan "Riwayat Aktivitas Publik" ke paling atas
...
(function(){
  ...
  function run(){
    // 1) Pindahkan "Riwayat Aktivitas Publik" ke paling atas
    var pubCard = null;
    document.querySelectorAll('.card').forEach(function(c){
      var h = c.querySelector(':scope > .card-header');
      if (h && norm(h.textContent).indexOf('Riwayat Aktivitas Publik') !== -1) pubCard = c;
    });
    if (pubCard) {
    ...
    // 2) Jadikan section berlabel sebagai spoiler
    document.querySelectorAll('.card').forEach(function(card){
      ...
      var id = 'rwspoil_' + Math.random().toString(36).slice(2,9);
      var wrap = document.createElement('div');

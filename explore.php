...
$pageTitle = 'Eksplorasi Rute & Peta Canggih';
$pageSkeleton = 'grid';

require_once __DIR__.'/includes/paket_helpers.php';
if (!isset($u) || !$u) { require_login(); $u = current_user(); }
paket_require_or_lock('komunitas', $u, 'Eksplorasi Rute & Peta Canggih',
    'Eksplorasi Rute & Peta Canggih tersedia untuk paket Komunitas.');
...
<!-- ================================================================== -->
<hr class="my-4">
<details id="eksplorasi" class="mb-3" open>
